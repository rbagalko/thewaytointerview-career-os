-- TheWayToInterview v2 schema for March 19, 2026 launch.
-- This schema retains existing production table names where possible
-- and adds the minimum normalized structures needed for a Career OS.
...
-- Repeat the same ownership policy pattern for:
-- user_job_matches, job_saved, applications, jd_analyses, skill_gaps,
-- prep_roadmaps, prep_tasks, readiness_snapshots, linkedin_optimizations,
-- and mock_interviews.
--
-- jobs, job_sources, crawl_logs, learning_resources, and feature_flags should
-- be write-protected to service roles and admin functions only.
